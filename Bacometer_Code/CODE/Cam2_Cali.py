        ...
        while targetExposureReached == False:
            ...
            for frame in range(1,999):
                ...
                if avg == 0:
                    ...
                    cam.ExposureTime = shutterSpeed
                    f = open("/home/%s/Desktop/variable/exposure2" % name, 'w+t')
...
def cam1step2(serial):
    ...
    with Camera(index = serial) as cam:
        ...
        if os.path.isfile("/home/%s/Desktop/variable/exposure2" % name):
            f = open("/home/%s/Desktop/variable/exposure2" % name, 'r+t')
            exposure2 = f.read()
            print("step2_expoure2:", exposure2)
            f.close()
        ...
        f1 = open("/home/%s/Desktop/variable/cam2_xoffset" % name, 'w+t')
        f1.write(str(loc[0]))
        f1.close()

        f2 = open("/home/%s/Desktop/variable/cam2_yoffset" % name, 'w+t')
        f2.write(str(loc[1]))
        f2.close()
        cam.stop()
...
def cam1step3(serial):
    ...
    with Camera(index = serial) as cam:
        ...
        if os.path.isfile("/home/%s/Desktop/variable/exposure2_2" % name):
            f = open("/home/%s/Desktop/variable/exposure2_2" % name, 'r+t')
            exposure2 = f.read()
            print("step3_expoure2:", exposure2)
            f.close()
        ...
        while targetExposureReached == False:
            ...
            for frame in range(1,999):
                ...
                if avg == 0:
                    targetExposureReached =True
                    cam.ExposureTime = shutterSpeed
                    f = open("/home/%s/Desktop/variable/exposure2_2" % name, 'w+t')
                    f.write(str(shutterSpeed))
                    f.close()
                    break
                else:
...
if __name__=='__main__':
    ...
    cam1step3(1)
    check(1)
    print("cam2:Full ROI calibration finished")
