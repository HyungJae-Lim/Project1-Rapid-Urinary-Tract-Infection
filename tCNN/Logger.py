...
LOG_VALUES = {
    "train": ["loss"],
    "valid": ["acc", "test_acc", "valid_patch", "test_patch"],
    "test": ["train_acc", "valid_acc", "test_acc", "train_patch", "valid_patch", "test_patch", "time"]
}
...
class Logger:
    ...
    def will_write(self, line):
        ##temporarily removed by Gkim ##print(line)
